...
//	}
	...
	@AfterReturning(value = "execution(* com.ssafy.happyhouse.model..*.*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.happyhouse.model..*.*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.happyhouse.model..*.*(..))")
